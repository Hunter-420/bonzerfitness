  ...
  return (
    <div className="container mx-auto px-4 py-16 pt-32">
      <div className="max-w-3xl mx-auto">
        <Link href="/blog" className="text-blue hover:text-orange transition-colors mb-8 inline-block">
          &larr; Back to all posts
        </Link>
        <article className="prose lg:prose-xl dark:prose-invert">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-charcoal dark:text-white">
            {postData.title}
          </h1>
