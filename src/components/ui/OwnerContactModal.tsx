    ...
    <>
      ...
      >
        <div
          ...
          style={{
            transition:
              "opacity 350ms cubic-bezier(.4,0,.2,1), transform 350ms cubic-bezier(.4,0,.2,1)",
          }}
        >
          ...
          <div className="relative p-7 sm:p-10">
            ...
            >
              Is this{" "}
              <span className="bg-gradient-to-r from-[#00C6A2] to-[#4DD0E1] bg-clip-text text-transparent">
                your gym?
              </span>
            </h2>
            ...
            <div className="flex flex-col gap-3">
              ...
              >
                ...
                <span>Contact Developer Team on WhatsApp</span>
                <span
